...
public class Methods {
  public double money(){
      ...
      System.out.println("ne kadar pra yatirmak istersin");
      double money =scan.nextDouble();
      return money ;
  }
  //urun numarasını musteriye sectirip secilen urunun fiyatini return ediyor
    ...
    public double balance(double price,double money,Products product){
      ...
      while (money>=product.getPrice()){
          ...
          System.out.println("hesabinida " + money + "dolar var");
          Scanner scan=new Scanner(System.in);
